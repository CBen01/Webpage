...
export default function LandingPage() {
    ...
    return (
        <>
            ...
            <Box mb={100}>
                <Heading className="jef" mb={6} textAlign="center" id="jatek">Az Escape from The Horror House
                    játék</Heading>
            </Box>
            <Container maxW="container.lg" py={8} display="flex" flexDirection="column" alignItems="center">
                ...
                <Box display="flex" alignItems="center" justifyContent="space-between" width="100%" mb={6}>
                    <Box>
                        <Heading size="lg" mb={-6} ml={40}>Történet</Heading>
                        <Text id="test" flex="1" mr={4} mt={10}>
                    ...
                    <Image src="/images/story.svg" alt="Story Image" boxSize="300px" alignSelf="center" mb={200}/>
                </Box>

                <Heading className="jef" mb={"100px"} textAlign="center" id="menet">Játékmenet</Heading>
                <Box display="flex" alignItems="center" justifyContent="space-between" width="120%" mb={6} ml={"200px"}
                     mb="-200px">
                    <Image src="/images/tutorial.svg" alt="Story Image" boxSize="300px" alignSelf="center" mb={200}/>
                    <Box ml={200}>
                        <Heading size="lg" mb={-6} ml={"220px"}>Menet</Heading>
                        <Text id="test2" flex="1" ml={4} mt={10}>
                ...
                <Box textAlign="center" py={10} id="download-section" mb="200px" id="game">
                    ...
                    <Text mb={6} width={500}>Experience the thrill and excitement of Escape The Horror House. Click the
                        button below to download the game now!</Text>
                    <Button colorScheme="red" size="lg" onClick={() => window.location.href = '/Game/ETHH.zip'}>
                        Download Now!
                    </Button>
                </Box>
